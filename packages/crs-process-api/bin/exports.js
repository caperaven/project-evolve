...
* @returns {any}
*/
export function export_to_excel(data, fields) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(fields, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.export_to_excel(retptr, addHeapObject(data), ptr0, len0);
...
* @returns {any}
*/
export function import_from_excel(data, fields) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.import_from_excel(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('exports_bg.wasm', import.meta.url);
    }
    const imports = getImports();
